...
```
Added Windows 10 style title bar on Windows systems.  Original contributor is Ronnie Dutta.  Updated to IPCRenderer implementation code and drag region support added by yours truly.
```
<div id="titlebar">
    .
    .
