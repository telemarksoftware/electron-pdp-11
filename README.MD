...
This Electron app builds on the basis files contained within this zip file, and therefore are required for this application.
...
## Quickstart Tip
Download and install Node.js from the official website.  Later, when you install dependencies (see below), electron will automatically be installed as a node module.
```
https://nodejs.org
```
## How does it work?
...
```
Added Window 10 style title bar on Windows systems.  Original contributor is Ronnie Dutta.  Updated IPCRenderer implementation code and drag region support added by yours truly.
```
<div id="titlebar">
</div>
```
